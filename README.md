...
Speaker: [Shravan Vasishth](https://vasishth.github.io)
...
building an incorrect parse of a sentence.  In 1992, Altmann and colleagues
claimed that linguistic context largely eliminates such garden-path effects in
English. This claim has far-reaching implications because it goes against a
dominant belief in psycholinguistics: that incremental structure building
relies, at least initially, only on syntactic information (the syntax-first
